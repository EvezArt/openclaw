...
export function emitSystemEvent(runId, subtype, data, sessionKey) {
    emitAgentEvent({
        runId,
        stream: "system",
        sessionKey,
...
export function emitHypothesisEvent(runId, hypothesisData, sessionKey) {
    emitAgentEvent({
        runId,
        stream: "hypothesis",
        sessionKey,
...
export function emitHeartbeatRunEvent(runId, data, sessionKey) {
    emitAgentEvent({
        runId,
