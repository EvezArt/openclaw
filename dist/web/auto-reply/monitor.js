    ...
    while (true) {
        ...
        try {
            ...
            reconnectLogger.warn({
                ...
                reconnectAttempts,
                error: errorStr,
            }, "web reconnect: listener start failed");
            ...
            runtime.error(`WhatsApp Web connection start failed. Retry ${reconnectAttempts}/${reconnectPolicy.maxAttempts || "∞"} in ${formatDurationMs(delay)}… (${errorStr})`);
            try {
